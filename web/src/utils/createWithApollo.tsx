 ...
 */
export const initOnContext = (acp: ApolloClientParam, ctx: ContextWithApolloOptions) => {
  ...
  const apolloClient =
    ctx.apolloClient || initApolloClient(ac, ctx.apolloState || {}, inAppContext ? ctx.ctx : ctx);
